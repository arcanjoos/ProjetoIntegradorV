...
# # tabelaVendaSalgado = tabelaFormatada.loc[tabelaFormatada['categoria'] == 'Salgado']
# # tabelaVendaSalgado = tabelaFormatada.loc[tabelaFormatada['categoria'] == 'Salgado', ['nome', 'descricao','preco']]
